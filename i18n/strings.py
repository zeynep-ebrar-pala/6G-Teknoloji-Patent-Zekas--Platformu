...
429 olursa <code>x-rate-limit-retry-after-seconds</code> kadar beklenir.
        ...
        "pub": {
            ...
            "subtitle": "Springer Nature Meta API. ISAC, RIS, Cell-Free, THz, AI-RAN, NTN, Ambient IoT. Yıl / kurum / ülke / atıf / trend. Kaynak: {source}",
...
<p style="color:#CBD5E1;font-size:0.88rem;line-height:1.6;margin:10px 0 0 0;">
Yıl ve ülke: Meta <code>facet</code>. Türkiye listede yoksa metin «Turkey» sayısı eklenir (facet değil).
...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "metric_tr_count": "Türkiye (metin Turkey)",
            "cc_caption_all": "Her konuda Springer Meta ülke facet’i (ilk 20). Türkiye listede yoksa metin «Turkey» satırı eklenir; yöntem dipnotta yazılır. Yedi konu toplanmaz.",
            "inst_caption_all": "Çekilen Springer kayıtlarının Crossref bağlılığı. Tam külliyat kurum facet’i değil. Yedi konu toplanmaz.",
            "chart_trend": "Springer Nature Meta API — yıllara göre konu serisi (toplanmaz)",
            ...
            "metric_tr_springer_cap": "Springer Meta metin «Turkey»; Springer ülke facet sırası değildir. Yedi konu toplanmaz.",
            ...
            "cc_caption_tr": "Springer ülke facet’inde Türkiye satırı (metin Turkey eklentisi dahil). Başka ülke yok.",
            "cc_caption_eu": "Springer ülke facet penceresindeki Avrupa ülkeleri. Pencere dışı ülke uydurulmaz.",
            "inst_caption_tr": "Çekilen kayıtlarda Türkiye / Türk Telekom / Turkcell / Vodafone Türkiye geçen bağlılıklar. Yoksa çubuk yok; sayı uydurulmaz.",
            ...
            "year_caption": "Springer Nature Meta year facet, «6G {konu}», {y0}–{y1}. Tümü görünümünde yedi seri ayrıdır; toplanmaz. {end} eksik yıldır.",
...
7. Kaynak doğrulama kuralı: uydurma ID/sayı yok (1 dk)
        ...
        "charts": {
            ...
            "academic_trend": "Springer Nature Meta API — yıllara göre makale (year facet)",
...
On 429 the client waits <code>x-rate-limit-retry-after-seconds</code>.
        ...
        "pub": {
            ...
            "subtitle": "Springer Nature Meta API. ISAC, RIS, Cell-Free, THz, AI-RAN, NTN, Ambient IoT. Year / institution / country / cited / trend. Source: {source}",
...
<p style="color:#CBD5E1;font-size:0.88rem;line-height:1.6;margin:10px 0 0 0;">
Year and country: Meta <code>facet</code>. If Türkiye is missing, a text “Turkey” count is added (not a facet).
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "metric_tr_count": "Türkiye (text Turkey)",
            "cc_caption_all": "Per topic: Springer Meta country facet (top 20). If Türkiye is missing, a text «Turkey» row is added. Topics are not summed.",
            "inst_caption_all": "Crossref affiliations of pulled Springer records — not a full-corpus institution facet. Topics are not summed.",
            "chart_trend": "Springer Nature Meta API — topic series by year (not summed)",
            ...
            "metric_tr_springer": "Türkiye (Springer, {l0}–{l1})",
            "metric_tr_springer_cap": "Springer Meta text “Turkey”; not a Springer ülke facet rank. The seven topics are not summed.",
            ...
            "cc_caption_tr": "Türkiye row from the Springer country facet (including the Turkey text add-on). No other country is shown.",
            ...
            "inst_caption_tr": "Affiliations in the pulled records that mention Türkiye / Türk Telekom / Turkcell / Vodafone Türkiye. Empty if none; counts are not invented.",
            ...
            "year_caption": "Springer Nature Meta year facet, «6G {topic}», {y0}–{y1}. In the all-topics view the seven series are separate and not summed. {end} is incomplete.",
...
7. Source rule: no invented IDs or counts (1 min)
        ...
        "charts": {
            ...
            "academic_trend": "Springer Nature Meta API — papers by year (year facet)",
