...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "cc_caption_all": "Her konuda Springer ülke facet’i (bağlılık ülkesi, ilk 20). Çubuk o kayıttır ve aynı sayıya göre sıralanır; daha çok kayıt alta yazılmaz. Facet’te Türkiye yoksa metin «Turkey» o listeye kendi sayısıyla girer — iki yöntem bir eksende karıştırılmaz. Yedi konu toplanmaz.",
            ...
            "topic": {
                "ISAC": "ISAC (Integrated Sensing and Communication — Entegre Algılama ve İletişim)",
                "RIS": "RIS (Reconfigurable Intelligent Surface — Yeniden Yapılandırılabilir Akıllı Yüzey)",
                "Cell-Free": "Hücresiz MIMO (Cell-Free Massive MIMO)",
                "THz": "THz (Terahertz haberleşme)",
                "AI-RAN": "AI-RAN (AI-Native Radio Access Network — yapay zekâ tabanlı telsiz erişim ağı)",
                "NTN": "NTN (Non-Terrestrial Network — Karasal Olmayan Ağ)",
            ...
            "cc_caption": "Springer ülke facet (bağlılık ülkesi, ilk 20). Çubuk o kayıttır; sıra bu sayıya göredir. Facet’te Türkiye yoksa metin «Turkey» listeye o sayıyla girer (facet değil). Ortak yazarlı kayıt birden fazla ülkede sayılır; çubuklar toplanmaz.",
...
Patent ofisleri bu sayfada yoktur — Patent Zekası’ndadır.
        ...
        "sources": {
            ...
            "topic_search": "Konu taraması (ISAC, RIS, NTN, AI-RAN, THz, ortam IoT)",
            "topic_all": "Tümü",
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "cc_caption_all": "Per topic: Springer country facet (affiliation country, top 20). Bars are that count and are ordered by it; a larger count is not drawn below a smaller one. If Türkiye is missing from the facet, a text-“Turkey” row enters the same list by its own count — the two methods are not mixed on one axis. Topics are not summed.",
            ...
            "topic": {
                ...
                "Ambient IoT": "Ambient IoT (energy-harvesting / battery-free IoT)",
            },
            ...
            "cc_caption": "Springer country facet (affiliation country, top 20). The bar is that count; rank follows it. If Türkiye is missing from the facet, a text-“Turkey” row enters the list by that count (not a facet). A co-authored record can count in more than one country; bars are not summed.",
...
Patent-office tables are not on this page — they sit on Patent Intelligence.
        ...
        "sources": {
            ...
            "topic_search": "Topic search (ISAC, RIS, NTN, AI-RAN, THz, ambient IoT)",
            "topic_all": "All",
