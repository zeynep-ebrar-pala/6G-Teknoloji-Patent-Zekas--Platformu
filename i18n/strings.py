...
429 olursa <code>x-rate-limit-retry-after-seconds</code> kadar beklenir.
            ...
            "live_gp_spin": "Lens.org tam sayılar soruluyor (ilk sefer birkaç dakika; sonra önbellek)",
...
On 429 the client waits <code>x-rate-limit-retry-after-seconds</code>.
            ...
            "live_gp_spin": "Asking Lens.org for integer totals (first load can be long; then cached)",
