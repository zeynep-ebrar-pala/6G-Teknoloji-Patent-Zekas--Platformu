...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "chart_two_heading": "2. grafik — konuya göre toplam",
            "chart_two_title": "Konuya göre toplam makale (seçilen yıl penceresi)",
            "chart_two_body": "Her çubuk bir 6G konusunun {y0}–{y1} aralığındaki toplamıdır. Uzun çubuk o konuda daha çok kayıttır. Konular birbirine eklenmez.",
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "chart_two_heading": "Chart 2 — totals by topic",
            "chart_two_title": "Papers by topic in the selected year window",
            "chart_two_body": "Each bar is that 6G topic’s total in {y0}–{y1}. A longer bar means more records. Topics are not summed.",
