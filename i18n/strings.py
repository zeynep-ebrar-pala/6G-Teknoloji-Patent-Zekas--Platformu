...
Patent ofisleri ve USPTO tabloları bu sayfada yoktur — Patent Zekası’ndadır.
        ...
        "sources": {
            ...
            "topic_pub_caption": "Açılır kutu bu sayfadaki kartları ve sayıları seçilen 6G konusuna indirir. Düğmeler aynı sorguyu yayın veritabanında yeni sekmede açar.",
            ...
            "topic_live_all_pub": "Kilitli DOI setinde **{n}** makale (tüm konular). Konu seçince kartlar o alana iner.",
            "topic_live_one_pub": "Kilitli DOI setinde «{topic}»: **{n}** makale. Düğme yeni sekmede «{q}» aramasını açar.",
            ...
            "totals_caption_pub": "IEEE / Springer / Elsevier: Crossref query.title + DOI öneki (2020–2026, dergi makalesi). OpenAlex: konu araması 2020–2025. Scholar ve WoS API yok. Bu sayılar IEEE Xplore yerli hit’i değildir.",
            ...
            "method_crossref_ieee": "Crossref query.title + önek 10.1109",
            "method_crossref_springer": "Crossref query.title + önek 10.1007",
            "method_crossref_elsevier": "Crossref query.title + önek 10.1016",
...
Patent-office tables are not on this page — they sit on Patent Intelligence.
        ...
        "sources": {
            ...
            "topic_pub_caption": "The drop-down drops the cards and counts on this page to the chosen 6G topic. The buttons open the same query on the publication database in a new tab.",
            ...
            "topic_live_all_pub": "Locked DOI set: **{n}** papers (all topics). Pick a topic and the cards drop to that field.",
            "topic_live_one_pub": "Locked DOI set “{topic}”: **{n}** papers. A button opens a “{q}” search in a new tab.",
            ...
            "totals_caption_pub": "IEEE / Springer / Elsevier: Crossref query.title + DOI prefix (2020–2026, journal article). OpenAlex: topic search 2020–2025. Scholar and WoS have no API. These are not native IEEE Xplore hit counts.",
            ...
            "method_crossref_ieee": "Crossref query.title + prefix 10.1109",
            "method_crossref_springer": "Crossref query.title + prefix 10.1007",
            "method_crossref_elsevier": "Crossref query.title + prefix 10.1016",
            "method_openalex": "OpenAlex search 2020–2025",
        },
        "scenario": {
