...
<li><strong>WoS (Clarivate)</strong> — kurumsal / kütüphane. Bireysel Gmail pratikte yetmez.</li>
            ...
            "cc_rank_caption": "WoS ilk 10 + Türkiye satırı. Türkiye çubukta yoksa tam sıra bu önbellekte yok; Springer sayısı aynı eksene yazılmaz.",
            "cc_overview_caption": "Altı konu ayrı. Türkiye ilk 10’da değilse sıra uydurulmaz. Springer metin Turkey ≠ WoS CU sırası.",
            ...
            "cc_caption_wos_all": "Her konu kendi WoS ilk 10 ülkesi. Altı konu toplanmaz. Türkiye ilk 10’da yoksa sıra uydurulmaz; altta Springer 2022–2026 metin Turkey sayısı ayrı durur.",
...
<li><strong>WoS (Clarivate)</strong> — institutional / library. A personal Gmail almost never works.</li>
            ...
            "cc_rank_caption": "WoS top 10 plus a Türkiye row. If Türkiye is missing from the bars, the exact rank is not in this cache; the Springer count is not drawn on the same axis.",
            "cc_overview_caption": "The six topics stay separate. If Türkiye is not in a topic’s top 10, the rank is not invented. Springer text-Turkey ≠ WoS CU rank.",
            ...
            "cc_caption_wos_all": "Each topic has its own WoS top 10 countries. The six topics are not summed. If Türkiye is not in the top 10, the rank is not invented; Springer 2022–2026 text-Turkey counts sit under each chart.",
