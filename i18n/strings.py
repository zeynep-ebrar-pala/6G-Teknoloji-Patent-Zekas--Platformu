...
Denklem, varsayım ve geçerlilik penceresi <strong>6G Teknoloji Rehberi</strong> uzman katmanındadır.
            ...
            "radar_caption": "Lens patent + Springer yayın; log10 göreli yoğunluk (seri içi peak=100).",
...
7. Kaynak doğrulama kuralı: uydurma ID/sayı yok (1 dk)
        ...
        "charts": {
            ...
            "evidence_title": "Lens patent × Springer yayın (log10 göreli, peak=100)",
            "evidence_patent": "Lens patent",
            "evidence_pub": "Springer yayın",
            "evidence_hover_patent": "%{theta}<br>Göreli %{r}<br>Lens total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Göreli %{r}<br>Springer total: %{customdata}<extra></extra>",
...
Equations, assumptions and validity windows sit in the expert layer of <strong>6G Technology Explorer</strong>.
            ...
            "radar_caption": "Lens patents + Springer publications; log10 relative intensity (peak=100 within each series).",
...
7. Source rule: no invented IDs or counts (1 min)
        ...
        "charts": {
            ...
            "trl_hover": "%{theta}<br>TRL %{r}<br>%{customdata}<extra></extra>",
            "evidence_title": "Lens patents × Springer pubs (log10 relative, peak=100)",
            "evidence_patent": "Lens patents",
            "evidence_pub": "Springer pubs",
            "evidence_hover_patent": "%{theta}<br>Relative %{r}<br>Lens total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Relative %{r}<br>Springer total: %{customdata}<extra></extra>",
