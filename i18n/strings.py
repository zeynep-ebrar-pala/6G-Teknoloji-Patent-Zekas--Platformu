...
Denklem, varsayım ve geçerlilik penceresi <strong>6G Teknoloji Rehberi</strong> uzman katmanındadır.
            ...
            "radar_caption": "Her örümcek kendi tablo sütununa doğrusal orantılıdır (100% = sütun max); köşe etiketleri ham total.",
...
7. Kaynak doğrulama kuralı: uydurma ID/sayı yok (1 dk)
        ...
        "charts": {
            ...
            "evidence_hover_patent": "%{theta}<br>Oran %{r}%<br>Lens total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Oran %{r}%<br>Springer total: %{customdata}<extra></extra>",
...
Equations, assumptions and validity windows sit in the expert layer of <strong>6G Technology Explorer</strong>.
            ...
            "radar_caption": "Each spider is linearly proportional to its table column (100% = column max); vertex labels = raw totals.",
...
7. Source rule: no invented IDs or counts (1 min)
        ...
        "charts": {
            ...
            "evidence_hover_patent": "%{theta}<br>Share %{r}%<br>Lens total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Share %{r}%<br>Springer total: %{customdata}<extra></extra>",
