...
Patent ofisleri ve USPTO tabloları bu sayfada yoktur — Patent Zekası’ndadır.
        ...
        "sources": {
            ...
            "topic_pat_caption": "Konu değişince kilitli küme ve aşağıdaki ofis toplamları değişir. Toplam yalnızca herkese açık API’den gelirse yazılır.",
            "topic_pub_heading": "### Konu taraması — yayın veritabanları",
            "topic_pub_caption": "Konu değişince kilitli kartlar ve aşağıdaki yayın toplamları değişir. Scholar / WoS genel API sunmaz; sayı «—» kalır.",
...
Patent-office tables are not on this page — they sit on Patent Intelligence.
        ...
        "sources": {
            ...
            "topic_pat_caption": "Changing the topic changes the locked sample and the office totals below. A total is written only when a public API returns it.",
            "topic_pub_heading": "### Topic search — publication databases",
            "topic_pub_caption": "Changing the topic changes the locked cards and the publication totals below. Scholar / WoS have no public count API; the cell stays “—”.",
