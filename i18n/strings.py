...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "chart_topic": "Konuya göre toplam makale",
            ...
            "chart_two_title": "{y0}–{y1} yıllarının toplamı (üstteki çizgiler toplanır)",
            "chart_two_body": "Yıl sen seçmiyorsun. Pencere sabittir: {y0}’den {y1}’e. Her çubuk, 1. grafikte aynı konunun çizgisindeki sayıları toplar. ISAC örneği: 2020+2021+…+{y1}. Yedi çubuk birbirine eklenmez.",
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "chart_topic": "Papers by topic (totals)",
            ...
            "chart_two_title": "Sum of {y0}–{y1} (the lines above, added)",
            "chart_two_body": "You do not pick the years. The window is fixed: {y0} to {y1}. Each bar adds that topic’s yearly counts from chart 1. ISAC example: 2020+2021+…+{y1}. The seven bars are not added together.",
