...
ve geçerlilik penceresi <strong>6G Teknoloji Rehberi</strong>nin uzman katmanında yer alır.
        ...
        "trl": {
            ...
            "explainer_ntn": "Seviye 6 — NTN: Kamuya açık denemeler yapılmıştır; karasal şehir kulesine tamamlayıcıdır.",
        ...
        "tech": {
            ...
            "perf_heading": "### Performans KPI — hız, gecikme, menzil, kazanç",
            "perf_caption": "Bu grafikler makale veya patent sayısı değildir. Değerler literatür, laboratuvar ve demo sınıfıdır; Türk Telekom abone şebekesinde ölçülmemiştir.",
            "empty_perf": "Bu teknoloji için performans KPI kümesi henüz tanımlanmamış.",
            "records_heading": "### Literatür ve patent kayıt trendleri",
            "records_caption": "Patent çubuğu: Lens.org total (konu DSL + year_published). Yayın çizgisi: Springer Nature Meta year facet. Kayıt sayısı performans metriği değildir; anahtar yoksa grafik gizlenir, 0 uydurulmaz.",
...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "cited_caption": "Springer örneklem + Crossref atıf. Sıra: atıf yüksekten düşüğe; aynı atıfta yıl yeniden eskiye. Atıf > 0 olanlar önce; 2026 erken çevrimiçi kayıtlar 0 olabilir. Tam külliyat facet değildir.",
            ...
            "cited_zero_hint": "Üstteki kayıtların atıfı 0 ise erken 2026 çevrimiçi yayın olabilir; arka planda örneklem yenileniyor. Atıf > 0 olanlar listede öne alınır.",
...
Ofis USPTO’dur; kart düğmesi kaydı <strong>Lens.org</strong>’da açar. Sayılar kilitli örnek kümedir; rakip Lens toplamı veya küresel SEP payı değildir.
            ...
            "presence_heading": "### Türk Telekom’un 6G işbirlikleri (resmi duyuru)",
            "presence_caption": "Her kartta Türk Telekom bir taraftır (MoU, deneme, konsorsiyum ortağı). Ülke etiketi imza yeri veya standart organıdır; o ülkede TT abone şebekesi demek değildir. Kaynak düğmesi orijinal duyuruyu açar.",
...
Patentler Patent Zekası'ndadır.
            ...
            "rank_caption": "Üç operatör Wikipedia Avrupa MNO listesindeki bu ülke satırından kilitlendi; abone/gelir «en yüksek 3» bu platformda ölçülmedi. Yayın = 6G konu + kurum ID (yoksa bağlılık dizesi). Patent = kilitli USPTO örnek (Netsia yalnız TR, Lens.org). 0 kayıt sıra almaz (—). Küresel SEP veya pazar payı değildir.",
            "rank_caption_pat": "Bu ülkede Wikipedia’daki 3 MNO + TT. Patent = kilitli USPTO örnek kümesi (Netsia yalnız TR); kartlar Lens.org’da açılır. Kaydı 0 olan firma çizilmez; sıra uydurulmaz.",
            ...
            "rank_tt_pub": "Türk Telekom bu ülkede: {pub_n} kilitli DOI bağlılığı (TR) veya Springer 6G metin sayımı. Rakip ölçülmediyse —; sıra uydurulmaz.",
            "rank_empty_pub": "Bu ülkede üç operatör için Springer sayımı 0. Çubuk çizilmez; tabloda 0 veya —.",
            "rank_pub_pending": "Springer yayın sayıları henüz önbellekte değil. Arka planda yükleniyor; birkaç dakika sonra yenileyin.",
...
ve gerçek fiber topolojisi modele girmez. Sayıyı «ölçülmüş 6G performansı» diye okumayın.
        ...
        "charts": {
            ...
            "perf_value": "Değer",
            "perf_hover": "%{x}<br><b>%{text}</b><extra></extra>",
        },
        "diagram": {
...
and validity windows live in the expert layer of <strong>6G Technology Explorer</strong>.
        ...
        "trl": {
            ...
            "explainer_ntn": "Level 6 — NTN: Public trials have been conducted; it complements the terrestrial city tower.",
        ...
        "tech": {
            ...
            "perf_heading": "### Performance KPIs — rate, latency, range, gain",
            "perf_caption": "These charts are not publication or patent counts. Values are literature, laboratory, and demo class; not measured on the Türk Telekom retail network.",
            "empty_perf": "No performance KPI set is defined for this technology yet.",
            "records_heading": "### Publication and patent record trends",
            "records_caption": "Patent bars: Lens.org total (topic DSL + year_published). Publication line: Springer Nature Meta year facet. Record counts are not performance metrics; charts stay hidden without keys; 0 is not invented.",
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "cited_caption": "Pulled Springer sample + Crossref citations. Order: citations high to low; within the same count, year newest to oldest. Papers with citations > 0 come first; early 2026 online records may show 0. Not a full-corpus citation facet.",
            ...
            "cited_zero_hint": "If top records show 0 citations they may be early 2026 online papers; the sample refreshes in the background. Records with citations > 0 are listed first.",
...
The office is USPTO; the card button opens the record on <strong>Lens.org</strong>. Counts are from a locked sample — not Lens rival totals or global SEP share.
            ...
            "presence_heading": "### Türk Telekom 6G collaborations (official announcements)",
            "presence_caption": "On every card Türk Telekom is a party (MoU, trial, or consortium partner). The country label is the signing venue or standards seat — not a claim that TT runs a retail network there. The source button opens the original announcement.",
...
Patents sit on Patent Intelligence.
            ...
            "rank_caption": "The three operators are locked from that country’s row in the Wikipedia European MNO list; subscriber/revenue “top 3” was not measured here. Publication counts are a 6G topic search. Patent counts are the locked USPTO sample (Netsia on TR only, Lens.org). A zero count is unranked (—); zeros are not labelled “2nd”. Not global SEP or market share.",
            "rank_caption_pat": "The three Wikipedia MNOs + TT in this country. Patents = locked USPTO sample (Netsia on TR only); cards open on Lens.org. Firms with 0 records are not drawn; rank is not invented.",
            ...
            "rank_tt_pub": "Türk Telekom in this country: {pub_n} locked DOI affiliations (TR) or Springer 6G text count. Rivals not measured show —; rank is not invented.",
            "rank_empty_pub": "Springer counts are zero for all three operators in this country. Bars are not drawn; table shows 0 or —.",
            "rank_pub_pending": "Springer publication counts are not cached yet. Loading in the background; refresh in a few minutes.",
