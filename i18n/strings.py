...
ve gerçek fiber topolojisi modele girmez. Sayıyı «ölçülmüş 6G performansı» diye okumayın.
        ...
        "ai": {
            ...
            "caption": "Bağlamda olmayan patent numarası, DOI veya atıf sayısı üretilmez. Yanıt nedir / neden / nasıl (donanım) / ne zaman / sınır katmanlarını atlamaz.",
            "chip_ris": "RIS nedir?",
            ...
            "placeholder": "6G teknolojisi, donanım, patent veya makale hakkında sorun...",
            ...
            "pedagogy": "Anlatım kuralı: önemli kavramda Nedir, Neden gerekli, Ne işe yarar, Nasıl çalışır (dalga şekli + anten/RF/donanım varsa yaz), Ne zaman kullanılır, Ne zaman kullanılmaz, Neyle karıştırılmamalı, Gerçekte nerede çıkar. Kısaltmayı ilk geçişte «KISALTMA (English — Türkçe):» diye aç; sonra kısaltma kullan. Formül varsa sembol ve varsayımı söyle; ezberletme. Bağlamda olmayan sayı, patent ID, DOI, atıf uydurma. Emin değilsen «Platform verisinde bu bilgi yok» de.",
            "depth_beginner": "Seviye: TEMEL. Problem, ihtiyaç, yöntem, çalışma modeli, donanım/mimari, ne zaman/kullanılmaz ve neyle karıştırılmamalı ağırlıklı yaz. Çocuklaştırma. Denklem istersen sembolleri açıkla; varsayımı atlama.",
            "depth_expert": "Seviye: UZMAN. Kavramsal temeli ve donanımı atlama; ardından denklem, varsayım, sınır ve alternatif ekle.",
            ...
            "complete_rule": "Yanıtı yarım bırakma. Bağlamda donanım, mimari, kullanım ve sınır varsa hepsini yaz. Tek cümle veya tek paragraf yetmez. Dual-Depth: Temel katmanı atlama.",
            "system": "Türk Telekom 6G Ar-Ge asistanısın. Yalnızca verilen bağlamı kullan. Tahmin veya uydurma yapma. USER_LANGUAGE = tr. Yanıtı doğal, profesyonel Türkçe yaz; kelime kelime çeviri yapma. Teknik terimlerde yerleşik terminolojiyi kullan. Bölüm başlıklarını koru; donanım ve sınırı atlama.",
            "user_wrap": "Kullanıcı sorusu: {question}",
            "sec_what": "Nedir ve neden gerekli",
            "sec_how_hw": "Nasıl çalışır (dalga + anten / RF / donanım / mimari)",
            "sec_use": "Ne işe yarar / ne zaman kullanılır",
            "sec_limit": "Ne zaman kullanılmaz ve sınırlar",
            "sec_expert": "Uzman katmanı (denklem, varsayım, alternatif)",
            "sec_compare": "Karşılaştırma notu",
            "compare_hint": "İki teknoloji farklı problemi çözer; biri diğerinin yerine geçmez. Ortak nokta ve ayrım yukarıdaki donanım/mimari bloklarından okunur.",
            "sec_patents": "Patent veri özeti (Lens.org)",
            "patent_summary_body": "Bu platformda doğrulanmış örneklem: {total} patent kaydı (kaynak: {source}). Lider firma: {leader} ({leader_n}). En yoğun konu: {top_domain} ({top_domain_n}). Sayılar uydurulmaz.",
...
and the real fibre topology are not in the model. Do not read the numbers as measured 6G performance.
        ...
        "ai": {
            ...
            "pedagogy": "Teaching rule: for an important concept cover what it is, why it is needed, what it does, how it works (waveform + antenna/RF/hardware when present), when to use it, when not to, what not to confuse it with, and where it shows up in the real world. On first use expand an abbreviation as ABBR (English expansion); then use the abbreviation. If you cite an equation, name the symbols and the assumption; do not drill memorisation. Do not invent numbers, patent IDs, DOIs, or citation counts that are not in context. If you are unsure, say the platform data does not contain that information.",
            "depth_beginner": "Level: FOUNDATIONAL. Lead with problem, need, method, operating model, hardware/architecture, when / when-not, and what not to confuse it with. Do not talk down. If an equation is needed, explain the symbols and keep the assumption.",
            "depth_expert": "Level: EXPERT. Do not skip the conceptual foundation or the hardware; then add the equation, assumption, limit, and alternative.",
            ...
            "complete_rule": "Do not leave the answer half-finished. If the context has hardware, architecture, use, and limits, write all of them. One sentence or one paragraph is not enough. Dual-depth: do not skip the foundation layer.",
            "system": "You are the Türk Telekom 6G R&D assistant. Use only the given context. Do not guess or invent. USER_LANGUAGE = en. Write the answer directly in natural, professional English — do not translate from Turkish. Use established technical terminology. Keep section headings; do not skip hardware or limits.",
            "user_wrap": "User question: {question}",
            "sec_what": "What it is and why it is needed",
            "sec_how_hw": "How it works (waveform + antenna / RF / hardware / architecture)",
            "sec_use": "What it is for / when to use it",
            "sec_limit": "When not to use it and limits",
            "sec_expert": "Expert layer (equation, assumption, alternative)",
            "sec_compare": "Comparison note",
            "compare_hint": "The two technologies solve different problems; one does not replace the other. Shared points and differences are in the hardware/architecture blocks above.",
            "sec_patents": "Patent data summary (Lens.org)",
            "patent_summary_body": "Verified sample on this platform: {total} patent records (source: {source}). Leading firm: {leader} ({leader_n}). Top topic: {top_domain} ({top_domain_n}). Counts are not invented.",
