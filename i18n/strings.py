...
Denklem, varsayım ve geçerlilik penceresi <strong>6G Teknoloji Rehberi</strong> uzman katmanındadır.
        ...
        "tech": {
            ...
            "pat_chart_caption": "Lens.org patent/search total — konu DSL, year_published 2020–2026. Dokuz firma süzgeci yok; bu sayfa teknolojinin küresel konusudur.",
            "pub_chart_caption": "Springer Nature Meta API year facet — «6G {token}», 2020–2026. Crossref başlık-6G yedek değildir.",
...
429 olursa <code>x-rate-limit-retry-after-seconds</code> kadar beklenir.
            ...
            "bg_wait": "Sayılar arka planda doluyor ({done}/{total}). Sol menü serbest; bu sayfa otomatik yenilenmez.",
...
<strong>Kaynak:</strong> Springer Nature Meta API (<code>6G {token}</code>, 2020–2026). Konular toplanmaz.
...
Kurum ve atıf: çekilen kayıt + Crossref. Tam külliyat kurum facet’i yoktur; sayı uydurulmaz.
            ...
            "expert_body": """<p style="color:#E2E8F0;font-size:0.88rem;line-height:1.65;margin:8px 0 0 0;">
<strong>Springer Nature Meta API</strong> (<code>meta/v2/json</code>): sorgu <code>6G {token} onlinedatefrom:2020-01-01 onlinedateto:2026-12-31</code>.
...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "bg_wait": "Springer sayıları arka planda doluyor ({done}/{total}). Sol menü serbest.",
            "cc_tr_list_label_n": "{n}. Türkiye",
            "tr_rank_live": "Springer «{topic}»: Türkiye sırası **{rank}.** ({n} kayıt, ülke=Turkey/Turkiye, taranan ülke listesi). Springer Meta «6G {topic} Turkey» 2022–2026: **{springer}** (ülke sırası değildir; toplanmaz).",
            "cc_col_rank": "Sıra",
            "cc_col_country": "Ülke",
            ...
            "tr_in_top10": "Türkiye bu konunun Springer ilk 10 ülkesinde var. Springer Meta «6G {topic} Turkey» 2022–2026: **{n}** (ülke sırası değildir).",
            "tr_not_top10": "Springer Meta API facet «{topic}»: Türkiye ilk 10 ülkede yok. 10. ülkenin kayıt sayısı **{tenth}**. Tam sıra bu platformda ölçülmedi (tam ülke listesi yok). Springer Meta «6G {topic} Turkey», 2022–2026: **{n}**. Metin Turkey ≠ Springer CU sırası; iki katman toplanmaz.",
            "tr_not_top10_all": "Türkiye Springer ilk 10 listesinde yok. Springer (2022–2026, metin Turkey): {springer}. Konular toplanmaz.",
...
Patent ofisleri bu sayfada yoktur — Patent Zekası’ndadır.
        ...
        "sources": {
            ...
            "topic_live_all_pub": "Springer Nature Meta API: 6G {konu}, 2020–2026. Yedi konu çubuğu ayrıdır; toplanmaz.",
...
Equations, assumptions and validity windows sit in the expert layer of <strong>6G Technology Explorer</strong>.
        ...
        "tech": {
            ...
            "pat_chart_caption": "Lens.org patent/search total — topic DSL, year_published 2020–2026. Not filtered to the nine firms; this page is the technology’s global topic.",
            "pub_chart_caption": "Springer Nature Meta API year facet — “6G {token}”, 2020–2026. Not a Crossref title-6G fallback.",
...
On 429 the client waits <code>x-rate-limit-retry-after-seconds</code>.
            ...
            "bg_wait": "Totals are filling in the background ({done}/{total}). The sidebar stays free; this page does not auto-refresh.",
...
ISAC, RIS, Cell-Free Massive MIMO, THz, AI-Native RAN, NTN, Ambient IoT.
<strong>Source:</strong> Springer Nature Meta API (<code>6G {token}</code>, 2020–2026). Topics are not summed.
...
Institution and citations: pulled records + Crossref. There is no full-corpus institution facet; counts are not invented.
            ...
            "expert_body": """<p style="color:#E2E8F0;font-size:0.88rem;line-height:1.65;margin:8px 0 0 0;">
<strong>Springer Nature Meta API</strong> (<code>meta/v2/json</code>): query <code>6G {token} onlinedatefrom:2020-01-01 onlinedateto:2026-12-31</code>.
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "bg_wait": "Springer totals are filling in the background ({done}/{total}). The sidebar stays free.",
            "cc_tr_list_label_n": "{n}. Türkiye",
            "tr_rank_live": "Springer “{topic}”: Türkiye rank **{rank}.** ({n} records, ülke=Turkey/Turkiye, roster of countries). Springer Meta “6G {topic} Turkey” 2022–2026: **{springer}** (not a Springer rank; not summed).",
            "cc_col_rank": "Rank",
            ...
            "tr_in_top10": "Türkiye is in this topic’s Springer top 10. Springer Meta “6G {topic} Turkey” 2022–2026: **{n}** (not a Springer rank).",
            "tr_not_top10": "Springer Meta API facet “{topic}”: Türkiye is not in the top 10 countries. The 10th country has **{tenth}** records. The exact rank was not measured here (no full country list). Springer Meta “6G {topic} Turkey”, 2022–2026: **{n}**. Text Turkey ≠ Springer CU rank; the two layers are not summed.",
            "tr_not_top10_all": "Türkiye is not in the Springer top 10. Springer (2022–2026, text Turkey): {springer}. Topics are not summed.",
...
Patent-office tables are not on this page — they sit on Patent Intelligence.
        ...
        "sources": {
            ...
            "topic_live_all_pub": "Springer Nature Meta API: 6G {topic}, 2020–2026. The seven topic bars are separate and not summed.",
