...
<li><strong>WoS (Clarivate)</strong> — kurumsal / kütüphane. Bireysel Gmail pratikte yetmez.</li>
            ...
            "cc_caption_wos_all": "Tümü: her konu kendi WoS Analyze Results → Countries/Regions listesidir (önbellek). Altı konu toplanmaz. Springer Meta Basic ülke facet vermez.",
            ...
            "chart_cc_wos_all": "Ülkelere göre yayın — WoS Countries/Regions (konu ayrı, toplanmaz)",
...
<li><strong>WoS (Clarivate)</strong> — institutional / library. A personal Gmail almost never works.</li>
            ...
            "cc_caption_wos_all": "All topics: each topic is its own WoS Analyze Results → Countries/Regions list (cache). The six topics are not summed. Springer Meta Basic has no country facet.",
            ...
            "chart_cc_wos_all": "Publications by country — WoS Countries/Regions (topics separate, not summed)",
