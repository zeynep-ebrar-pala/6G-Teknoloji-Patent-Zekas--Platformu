...
Bu sayfa <strong>Springer Nature Meta API</strong> kullanır. Bireysel e-posta yeter. Anahtar: <code>SPRINGER_API_KEY</code>.
            ...
            "cited_caption_region": "Atıf sırası çekilen Springer kaydının Crossref sayısıdır. Yazar bağlılığında ülke etiketi yok; Avrupa dilimi uydurulmaz.",
            "empty_cited_region": "Atıf sıralı DOI yok. Sayı uydurulmaz.",
...
This page uses the <strong>Springer Nature Meta API</strong>. A personal email is enough. Key: <code>SPRINGER_API_KEY</code>.
            ...
            "cited_caption_region": "Rank is Crossref citation count on pulled Springer records. Author affiliation has no country tag; a Europe-only slice is not invented.",
            "empty_cited_region": "No citation-ranked DOI. Counts are not invented.",
