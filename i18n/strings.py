...
Denklem, varsayım ve geçerlilik penceresi <strong>6G Teknoloji Rehberi</strong> uzman katmanındadır.
            ...
            "radar_caption": "Radyal eksen ve etiketler sütun max’ına göre %’dir (100% = tablo max); ham sayılar yalnızca tabloda ve hover’da.",
...
7. Kaynak doğrulama kuralı: uydurma ID/sayı yok (1 dk)
        ...
        "charts": {
            ...
            "evidence_title": "Lens patent × Springer yayın (doğrusal, peak=100%)",
            "evidence_title_patent": "Lens patent (doğrusal, max=100%)",
            "evidence_title_pub": "Springer yayın (doğrusal, max=100%)",
            "evidence_patent": "Lens patent",
            "evidence_pub": "Springer yayın",
            "evidence_hover_patent": "%{theta}<br>Oran %{r}%<br>Ham total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Oran %{r}%<br>Ham total: %{customdata}<extra></extra>",
...
Equations, assumptions and validity windows sit in the expert layer of <strong>6G Technology Explorer</strong>.
            ...
            "radar_caption": "Radial axis and labels are % of that column’s max (100% = table max); raw integers only in the table and hover.",
...
7. Source rule: no invented IDs or counts (1 min)
        ...
        "charts": {
            ...
            "trl_hover": "%{theta}<br>TRL %{r}<br>%{customdata}<extra></extra>",
            "evidence_title": "Lens patents × Springer pubs (linear, peak=100%)",
            "evidence_title_patent": "Lens patents (linear, max=100%)",
            "evidence_title_pub": "Springer pubs (linear, max=100%)",
            "evidence_patent": "Lens patents",
            "evidence_pub": "Springer pubs",
            "evidence_hover_patent": "%{theta}<br>Share %{r}%<br>Raw total: %{customdata}<extra></extra>",
            "evidence_hover_pub": "%{theta}<br>Share %{r}%<br>Raw total: %{customdata}<extra></extra>",
