...
section = select_section("Teknoloji bölümü", TECH_SECTIONS, key=f"tech_section_{selected_tech_id}")

if section == "1. Teknoloji Tanımı":
...
elif section == "2. Çalışma Prensibi & Blok Diyagram":
...
elif section == "3. Sistem Mimarisi":
...
elif section == "4. Kullanım Alanları":
    render_use_cases(tech, beginner=beginner)

elif section == "5. Avantajlar & Dezavantajlar":
    render_adv_dis(tech, beginner=beginner)

elif section == "6. Dünyadaki Çalışmalar & TT Senaryoları":
